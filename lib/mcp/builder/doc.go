...
// entry point that sets GasLimit, leaves Fee.Amount empty for CLOB msgs,
// serializes TxBody+AuthInfo round-1, precomputes SIGN_MODE_DIRECT
// sign-bytes, and returns a *payload.TxPayload.
//
